...
const WeatherCanvas = forwardRef<WeatherCanvasHandle, Props>(
    ({ zClass }, ref) => {
        ...
        const setup = () => {
            ...
            // Perf: на coarse pointer (mobile/tablet) cap DPR at 1.0 вместо 2.
            // iPhone 15 native DPR=3 → 1.0 даёт -66% pixel area vs cap=2.
            // Лёгкая potери crispness на тонких rain lines, но 1px на DPR 3
            // всё равно сглаживается subpixel-rendering'ом.
            const isCoarse =
                window.matchMedia?.("(pointer: coarse)")?.matches === true;
            const dprCap = isCoarse ? 1.0 : 2;
